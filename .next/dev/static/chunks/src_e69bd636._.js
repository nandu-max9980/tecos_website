...
function SmoothScroll() {
    ...
    if ($[0] !== "e4f1f7a0d0dfa82c57fabb6f98f93f0c091a67a79f624af538022c85f5e8679a") {
        for(let $i = 0; $i < 2; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "e4f1f7a0d0dfa82c57fabb6f98f93f0c091a67a79f624af538022c85f5e8679a";
    }
    let t0;
...
function Header() {
    ...
    if ($[0] !== "6941692ce0e287d71cd62ff9a9056707577d1ce387645126541b01d9f44b29f9") {
        for(let $i = 0; $i < 14; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "6941692ce0e287d71cd62ff9a9056707577d1ce387645126541b01d9f44b29f9";
    }
                ...
                const handleScroll = {
                    "Header[useEffect() > handleScroll]": ()=>{
                        ...
                        throttleRef.current = setTimeout({
                            "Header[useEffect() > handleScroll > setTimeout()]": ()=>{
                                setIsScrolled(window.scrollY > 50);
                                throttleRef.current = null;
                            }
                        }["Header[useEffect() > handleScroll > setTimeout()]"], 16);
                    }
                }["Header[useEffect() > handleScroll]"];
    ...
    const t2 = isScrolled ? "bg-black/50 backdrop-blur-md border-white/10" : "bg-transparent";
    let t3;
    if ($[3] !== t2) {
        t3 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("fixed top-0 left-0 w-full z-50 transition-all duration-300 border-b border-transparent", t2);
        $[3] = t2;
        $[4] = t3;
    } else {
        t3 = $[4];
    ...
    if ($[7] !== mobileMenuOpen) {
        ...
        t7 = mobileMenuOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(NavLink, {
                    href: "#work",
                    onClick: {
                        "Header[<NavLink>.onClick]": ()=>setMobileMenuOpen(false)
...
_s(Header, "AU9wDijna0Ex9v5uBGtJG0ltJDs=");
_c = Header;
function NavLink(t0) {
    ...
    const { href, children, onClick } = t0;
    let t1;
    if ($[1] !== children || $[2] !== href || $[3] !== onClick) {
...
//# sourceMappingURL=src_e69bd636._.js.map